...
! function (t) {
    ...
    e.prototype = {
        ...
        error: function (e) {
            var i, n = this.$form.find(".form-group"),
                o = this.$form.find(".editable-error-block");
            if (e === !1) n.removeClass(t.fn.editableform.errorGroupClass), o.removeClass(t.fn.editableform.errorBlockClass).empty().hide();
            else {
                if (e) {
                    i = e.split("\n");
        ...
        save: function (e) {
            ...
            var i, n = "function" == typeof this.options.pk ? this.options.pk.call(this.options.scope) : this.options.pk,
                o = !!("function" == typeof this.options.url || this.options.url && ("always" === this.options.send || "auto" === this.options.send && null !== n && void 0 !== n));
    ...
    e.prototype = {
        ...
        init: function (i, n) {
            this.$element = t(i), this.options = t.extend({}, t.fn.editableContainer.defaults, n), this.splitOptions(), this.formOptions.scope = this.$element[0], this.initContainer(), this.delayedHide = !1, this.$element.on("destroyed", t.proxy(function () {
                ...
                var n, o = t(i.target),
                    r = [".editable-container", ".ui-datepicker-header", ".datepicker", ".modal-backdrop", ".bootstrap-wysihtml5-insert-image-modal", ".bootstrap-wysihtml5-insert-link-modal"];
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.list), t.extend(e.prototype, {
        renderList: function () {
            ...
            var e = function (i, n) {
                var o;
                if (t.isArray(n))
                    for (var r = 0; r < n.length; r++) o = {}, n[r].children ? (o.label = n[r].text, i.append(e(t("<optgroup>", o), n[r].children))) : (o.value = n[r].value, n[r].disabled && (o.disabled = !0), i.append(t("<option>", o).text(n[r].text)));
                return i
            };
...
function (t) {
    ...
    o.prototype = {
        ...
        moveMonth: function (t, e) {
            ...
            }, i = s + e, o.setUTCMonth(i), (0 > i || i > 11) && (i = (i + 12) % 12);
            else {
        ...
        dateUpdated: function (e) {
            ...
            if (-1 != o) {
                if (n < this.dates[o])
                    ...
                    for (; r > o && n > this.dates[o];) this.pickers[o++].setUTCDate(n);
                this.updateDates()
            }
        },
        remove: function () {
            ...
            return this.each(function () {
                ...
                if (!h) {
                    ...
                    if (c.is(".input-daterange") || g.inputs) {
                        var m = {
                            inputs: g.inputs || c.find("input").toArray()
                        };
    ...
    var h = t.fn.datepicker.dates = {
        ...
        d = {
            ...
            parseDate: function (i, n, r) {
                ...
                var p, f, s, c = i && i.match(this.nonpunctuation) || [],
                    i = new Date,
                    g = {},
