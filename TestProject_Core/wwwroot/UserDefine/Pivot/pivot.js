...
(function() {
  ...
  renderers = {
      "Table": function (pvtData, opts, Totals_Label) {
          return pivotTableRenderer(pvtData, opts, Totals_Label);
    },
      "Table Barchart": function (pvtData, opts, Totals_Label) {
          return $(pivotTableRenderer(pvtData, opts, Totals_Label)).barchart();
    },
      "Heatmap": function (pvtData, opts, Totals_Label) {
        return $(pivotTableRenderer(pvtData, opts, Totals_Label)).heatmap();
    },
      "Row Heatmap": function (pvtData, opts, Totals_Label) {
          return $(pivotTableRenderer(pvtData, opts, Totals_Label)).heatmap("rowheatmap");
    },
      "Col Heatmap": function (pvtData, opts, Totals_Label) {
          return $(pivotTableRenderer(pvtData, opts, Totals_Label)).heatmap("colheatmap");
    }
  };
  ...
  pivotTableRenderer = function (pivotData, opts, Totals_Label) {
  ...
  $.fn.pivot = function (input, opts, Totals_Label) {
    ...
    try {
      ...
      try {
          result = opts.renderer(pivotData, opts.rendererOptions, Totals_Label);
      } catch (_error) {
        e = _error;
